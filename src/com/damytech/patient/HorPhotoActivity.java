...
public class HorPhotoActivity extends Activity implements SurfaceHolder.Callback, Camera.PreviewCallback, Camera.PictureCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horphoto);
    ...
    private void initControl()
    {
        ...
        mHolder.addCallback(HorPhotoActivity.this);
    ...
    public void getJpgPhoto ( int nFileNo ) {
        ...
        if (srcFile.exists())
        {
            ...
            Bitmap bmpRot = BitmapFactory.decodeFile(GlobalData.createFileName(nFileNo));
...
//                outStream.close();
                ...
                Intent intent = new Intent(HorPhotoActivity.this, CompareActivity.class);
...
//        }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (mCamera == null)
        {
            GlobalData.showToast(HorPhotoActivity.this, getString(R.string.cameranotavailable));
            finish();
        }
        ...
        Size mScreenSize = param.getSupportedPreviewSizes().get(0); // for init
        mScreenSize.width = getResources().getDisplayMetrics().widthPixels;
        mScreenSize.height = getResources().getDisplayMetrics().heightPixels;
